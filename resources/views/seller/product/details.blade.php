                                ...
                                <div class="w-full rounded-lg mt-2 bg-gray-light p-2">
                                    <table class="w-full border-collapse">
                                        ...
                                        <tr class="bg-yellow-200">
                                            <th class="py-2 px-4 border border-gray-300">Price I Set</th>
                                            <td class="py-2 px-4 border border-gray-300">{{ $sellerProduct->seller_price ? price_format($sellerProduct->seller_price) : ''}}</td>
                                        </tr>
                                        <tr>
