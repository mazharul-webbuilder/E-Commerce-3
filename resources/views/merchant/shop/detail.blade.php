                            ...
                            <div class="">
                                <div class="w-full rounded-lg mt-2 bg-gray-light p-2">
                                    <table class="w-full">
                                        ...
                                        <tr>
                                            <th>Purchase Coin</th>
                                            <td>{{$product->current_coin ? : ''}}</td>
                                        </tr>
                                        <tr>
                                            <th>Previous Coin</th>
                                            <td>{{$product->previous_coin ? : ''}}</td>
                                        </tr>
                                        <tr>
                                            <th>Discount Price</th>
                                            <td>{{ $product->purchase_price ? price_format($product->purchase_price) : ''}}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $product->previous_price ? price_format($product->previous_price) : ''}}</td>
                                        </tr>
                                        <tr>
                                            <th>Review</th>
                                            <td>80</td>
                                        ...
                                        <tr>
                                            <th>Delivery Charge in Dhaka</th>
                                            <td>{{ $product->delivery_charge_in_dhaka }}</td>
                                        </tr>
                                        <tr>
                                            <th>Delivery Charge out Dhaka:</th>
                                            <td>{{ $product->delivery_charge_out_dhaka }}</td>
                                        </tr>
                                        <tr>
