...
@section('content')
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="javascript:void(0)" class="flex items-center hover:scale-105">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">My Shop Detail</span>
                        </a>
                    </li>
                </ol>
            </div>
            ...
            <section class="py-3">
                <div class="">
                    <h2 class="py-3 bg-purple-600 text-white text-2xl pl-2">MY Shop Detail</h2>
                    <div class="">
                        <div class="flex py-1">
            ...
            <div class="">
                <h2 class="py-3 bg-purple-600 text-white text-2xl pl-2">My Shop All Published Products</h2>
            </div>
