                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="#" class="flex items-center hover:scale-105">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Deposit History</span>
                        </a>
                    </li>
                </ol>
            </div>
                        ...
                        @foreach ($datas as $data)
                            <tr
                                ...
                                <td class="px-2 py-4 text-black border-r text-center">
                                    ...
                                    <img class="w-60 h-30 rounded-lg" src="{{asset('uploads/deposit/'.$data->image)}}" alt="image" >
                                </td>
