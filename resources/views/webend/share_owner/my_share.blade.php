    ...
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="#" class="flex items-center hover:scale-105">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">My Shares</span>
                        </a>
                    </li>
                </ol>
            </div>
            ...
            <div class="flex justify-end">
                ...
                <a href="javascript:;" data-action="{{route('share_owner.purchase_share')}}"
                   class="purchase_share text-white bg-purple-700 hover:bg-blue-800 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-3 py-2 text-center mr-2">
                    ...
                    <table class="text-sm text-left text-white border-l border-r" id="dataTableAuthor"
                        ...
                        @foreach ($datas as $data)
                            <tr
                                ...
                                <td class="px-2 py-4 text-black border-r text-center">
                                    <a  data-action="javascript:;" data-te-toggle="modal" share_id="{{$data->id}}"
                                        data-te-target="#exampleModal"
                                        data-te-ripple-init
                                        data-te-ripple-color="light"
                                        href="javascript:void(0)" class="transfer_share text-white bg-purple-400 hover:bg-sky-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center
...
@section('extra_js')
    ...
    <script !src="">
        $(function (){
            ...
            $('body').on('click','.purchase_share',function (){
                swal({
                    title: "Do You want to purchase share? {{share_holder_setting()->share_price}} Coin will be charged.",
                    icon: "info",
                    buttons: true,
                    dangerMode: true,
                })
                                ...
                                success:function(response){
                                  //  console.log(response.status)
                                    if(response.status=="200"){
                                        ...
                                        swal({
                                            title: 'Opps, Insufficient balance!',
                                            text: response.message,
                                            icon: response.type,
                                            timer: 5000,
                                        })
