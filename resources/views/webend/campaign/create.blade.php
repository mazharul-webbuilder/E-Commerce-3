    ...
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Create Campaign</span>
                        </div>
                    </li>
                </ol>
            </div>
            <div class="border border-[#8e0789] rounded-md mt-10 mb-8">
                ...
                <!-- Category form start -->
                <form id="submit_form" action="{{ route('campaign.store') }}" method="POST" enctype="multipart/form-data" >
                    @csrf
                    <div class="flex flex-col gap-4 p-4 mt-3">
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <div class="w-1/3">
                                <div class="w-full">
                                    <h4 class="mb-2 font-medium text-zinc-700">Campaign Title </h4>
                                    <input name="campaign_title" required class=" w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" placeholder="Campaign Title.." type="text">

                                </div>
                            </div>
                            <div class="w-1/3">
                                <div class="w-full">
                                    <h4 class="mb-2 font-medium text-zinc-700">Tournament </h4>
                                    <select name="tournament_id"  class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none">
                            ...
                            <div class="w-1/3">
                                <div class="w-full">
                                    <h4 class="mb-2 font-medium text-zinc-700">Campaign Position </h4>
                                    <select name="position_id"  class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none">
                                        @foreach($campaign_position as $data)
                            ...
                            <div class="w-1/3">
                                <div class="w-full">
                                    ...
                                    <input  name="total_needed_position" required  class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number"  >
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3" id="date_count">
                            ...
                            <div class="w-1/3">
                                <div class="w-full">
                                    ...
                                    <input name="start_date" required  class="start_date w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                    <span class="free_login_coin_error text-red-400"></span>
                                </div>
                            </div>
                            ...
                            <div class="w-1/3">
                                <div class="w-full">
                                    ...
                                    <input name="end_date" required class="end_date w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text">
                            ...
                            <div class="w-1/4">
                                <div class="w-full">
                                    ...
                                    <input name="duration" readonly required class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" >
