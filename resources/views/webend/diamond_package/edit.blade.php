    ...
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                ...
                <!-- Category form start -->
                <form id="submit_form" data-action="{{ route('diamond_package.update') }}" method="POST">
                    @csrf
                    ...
                    <div class="flex flex-col gap-4 p-4 mt-3">
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <div class="w-full">
                                <div class="w-full">
                                    <h4 class="mb-2 font-medium text-zinc-700">Total Diamond in Package</h4>
                                    <input value="{{$package->total_diamond}}" name="total_diamond" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" required>
                                </div>
                                <div class="w-full">
                                    <h4 class="mb-2 font-medium text-zinc-700">Package Price</h4>
                                    <input value="{{$package->price}}"  name="price" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" required>
                                </div>
                            </div>
                        </div>
