        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10 mb-6">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Applied data user List</h2>
                </div>
                <div class="py-2 px-1 mt-3" style="overflow-x: auto;">
                    <h1 class="py-2 px-1"><strong>Data applied Date: {{date('d-m-Y',strtotime($user->data_applied_date))}}</strong></h1>
                    <h1 class="py-2 px-1"><strong>Data applied Expired Date: {{date('d-m-Y',strtotime($user->data_apply_expired_date))}}</strong></h1>
