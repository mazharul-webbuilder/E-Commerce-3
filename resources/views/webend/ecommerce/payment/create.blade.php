                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-full">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Payment Name" name="payment_name" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                            ...
                            <div class="flex flex-col md:flex-row justify-between gap-3">
                                <div class="w-full">
                                    <div class="w-full">
                                        ...
                                        <input placeholder="Enter bank_holder_name" name="bank_holder_name"
