                    ...
                    <div class="flex flex-col gap-4 p-4 mt-3">
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <div class="w-6/12">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Slider Title 1" name="title_1" value="{{$slider->title_1}}" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                            ...
                            <div class="w-6/12">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Slider Title 2" name="title_2" value="{{$slider->title_2}}" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                    <span class="error-message" id="email-error"></span>
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <div class="w-6/12">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Button Title" name="button_title" value="{{$slider->button_title}}" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                    <span class="error-message" id="email-error"></span>
                                </div>
                            </div>
                            <div class="w-6/12">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Button Link" name="button_link" value="{{$slider->button_link}}" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                    <span class="error-message" id="email-error"></span>
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-1/2">
                                ...
                                <div class="p-2">
                                    <h6 class="py-2">Current Image</h6>
                                    <img src="{{asset('uploads/slider/small'. '/' . $slider->image)}}" alt="">
                                </div>
                            </div>
                        </div>
