        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Slider Update</h2>
                </div>
                <!-- Category form start -->
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-6/12">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Slider Title" name="title" value="{{$slider->title}}" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                </div>
                            </div>
                            <div class="w-6/12">
                                <div class="w-full">
                                    <h4 class="mb-2 font-medium text-zinc-700">Priority</h4>
                                    <input placeholder="Enter Priority" value="{{$slider->priority}}" name="priority" min="1" oninput="validity.valid||(value='');" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" >
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-1/2">
                                ...
                                <div class="relative inline-flex w-full">
                                    <input  type='file' name="image"  class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none dropify"
                                            data-default-file="{{asset('uploads/slider/resize/'.$slider->image)}}"/>
                                </div>
