        ...
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="javascript:void(0)" class="flex items-center hover:scale-105">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Admins</span>
                        </a>
                    </li>
                </ol>
            </div>
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0 py-3 flex items-center">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Admin List</h2>
                </div>
                <br>
    ...
    <script>
        $(document).ready(function (){
            var table = $("#dataTable").DataTable({
                ...
                ajax: '{{ route('admin.all.datatable') }}',
                columns: [
