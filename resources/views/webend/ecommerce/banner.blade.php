...
@section('content')
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
            ...
            @if(Request::routeIs('banner.edit'))

            <!-- baner form start -->
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Banner Update</h2>
                </div>
                <!-- banner form start -->
                    ...
                    <div class="flex flex-col gap-4 p-4 mt-3">
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <div class="w-full">
                                <div class="w-full">
                                    <div class="w-full">
                                        <h4 class="mb-1 font-medium text-zinc-700">Image <span>(400x200)</span> </h4>
                                        <div class="w-full">
                                            <div class="ml-1 flex flex-col">
                                                ...
                                                <img id="blah" class="w-full h-64" style="display: {{$banner->image == null ? 'none' : 'block'}} " src="{{ asset($banner->image) }}" alt="your image"  />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="w-full">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Priority" name="priority" min="1" oninput="validity.valid||(value='');" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" value="{{ $banner->priority }}">
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col md:flex-row justify-between gap-3">
            ...
            @else
                <!-- baner form start -->
                    <div class="border border-[#8e0789] rounded-md mt-10">
                        <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                            <h2 class="text-2xl font-bold py-2 text-white pl-3">Banner Create</h2>
                        </div>
                        <!-- banner form start -->
                        <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-col gap-4 p-4 mt-3">
                                <div class="flex flex-col md:flex-row justify-between gap-3">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="w-full">
                                                    <div class="ml-1 flex flex-col">
                                                        ...
                                                        <img id="blah" style="display: none" src="#" alt="your image" width="180px" height="90px" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="w-1/2">
                                        <div class="w-full">
                                            <h4 class="mb-2 font-medium text-zinc-700">Banner Title (Optional)</h4>
                                            <input id="myDIV" placeholder="Enter Category Title" name="title" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                        </div>
                                    </div>
                                ...
                                <div class="w-1/2">
                                    <div class="w-full">
                                        ...
                                        <input placeholder="Enter Priority" min="1" oninput="validity.valid||(value='');" name="priority" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" >
                                    </div>
                                </div>
                    ...
                    <table class="text-sm text-left text-white border-l border-r" id="dataTableAuthor" style=" width: 100%;">
                        ...
                        <tr class=" bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-2 py-4 text-black border-r text-center">
                                @if($item->image != null)
                                    <img  src=" {{asset($item->image) }}" height="60px" width="60px">
                                @else
                                    No Image Found
                                @endif
                            </td>
                            ...
                            <td class="whitespace-nowrap space-x-1 text-center px-2 py-4 flex items-center justify-center">
                                <a href="{{ route('banner.edit',$item->slug) }}" class="text-white bg-sky-400 hover:bg-sky-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-5 py-2 text-center">
                                    <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                                    Edit
                                </a>
                                <a href="{{ route('banner.destroy',$item->id) }}" type="button" class="text-white bg-red-500 hover:bg-red-600 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-3 py-2 text-center deleteConfirmAuthor">
