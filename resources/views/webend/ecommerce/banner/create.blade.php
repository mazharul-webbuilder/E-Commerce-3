    ...
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="flex justify-end">
                <a style="text-decoration: none;" href="{{ \Illuminate\Support\Facades\URL::previous() }}"  class="text-white bg-blue-700 hover:bg-blue-800  transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-3 py-2 text-center">
                            ...
                            <div class="flex flex-col md:flex-row justify-between gap-3">
                                <div class="w-6/12">
                                    <div class="w-full">
                                        ...
                                        <input placeholder="Enter Slider Title" name="title" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                ...
                                <div class="w-6/12">
                                    <div class="w-full">
                                        ...
                                        <input placeholder="Enter Priority" name="priority" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                        <span class="error-message" id="email-error"></span>
                                    </div>
                                </div>
                            </div>
...
@section('extra_js')
    ...
    @include('webend.ecommerce.banner.banner-script')
@endsection
