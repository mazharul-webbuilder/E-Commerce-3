        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Review Coin Create</h2>
                </div>
                <!-- Category form start -->
                <form id="submit_form" data-action="{{ route('review_coin.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-full">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Review Coins" name="reward_coin" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" >
