    ...
    <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded-lg shadow-lg z-50 overflow-y-auto">
        ...
        <div class="modal-content py-4 text-left px-6">
            <div class="flex justify-between items-center pb-3">
                <p class="text-3xl font-semibold text-gray-800">Add New</p>
                {{--Modal Close button--}}
                <button id="addModalClose" class="modal-close cursor-pointer z-50 p-2">
            ...
            <!-- Flash Deal Form -->
            <form class="addModal" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    <label class="block text-gray-600 text-sm font-semibold mb-2" for="amount">Name*</label>
                    <input type="text" id="brandName" name="brand_name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-400" placeholder="Enter Amount">
