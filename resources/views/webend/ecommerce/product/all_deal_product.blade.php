    ...
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Flash Deal Products</span>
                        </div>
                    </li>
                </ol>
            </div>
            ...
            <div class="flex justify-end">
                <a href="{{URL::previous() }}"  class="text-white bg-blue-700 hover:bg-blue-800 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-3 py-2 text-center">
                ...
                <div class="py-2 px-1 mt-3" style="overflow-x: auto;">
                    <table class="text-sm text-left text-white border-l border-r" id="dataTableAuthor" style=" width: 100%;">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-2 py-3" style="width: 90px">
                            ...
                            <tr class="hide_row{{$product->id}} bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-2 py-4 text-black border-r text-center">
                                    <select data-action="{{route('product_status_update')}}" product_id="{{$product->id}}" name="status"
                                            class="change_product_status w-full h-6 h-10 pl-2 pr-5 cursor-pointer bg-white border border-gray-300 rounded-md appearance-none text-zinc-700 focus:outline-none">
                                        <option value="1" {{$product->status==1 ? 'selected' : ''}}> Publish</option>
                                        <option value="0" {{$product->status==0 ? 'selected' : ''}}> Unpublish</option>
                                    </select>
                                </td>
                                <td class="px-2 py-4 text-black border-r text-center">
                                    <a  data-bs-toggle="modal" data-bs-target="#exampleModalDeal" data-action="{{route('get_product_deal')}}" product_id="{{$product->id}}" href="javascript:void(0)" class="flash_deal_product_status text-white bg-red-500 hover:bg-sky-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-5 py-2 text-center">
                                        {{$product->flash_deal==1 ? 'Yes' : 'No' }}
                                    </a>
                                </td>
                                <td class="px-2 py-4 text-black border-r text-center">
                                    <a  data-action="{{route('show_product_status')}}" product_id="{{$product->id}}" data-bs-toggle="modal" data-bs-target="#exampleModal" href="javascript:void(0)" class="show_product_status text-white bg-purple-400 hover:bg-sky-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-5 py-2 text-center">
                                ...
                                <td class="whitespace-nowrap space-x-1 text-center px-2 flex items-center justify-center mt-3">
