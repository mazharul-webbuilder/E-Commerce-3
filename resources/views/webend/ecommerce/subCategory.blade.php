        ...
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Sub-Category</span>
                        </div>
                    </li>
                </ol>
            </div>
            <!-- end menu -->
            @if(Request::routeIs('sub-category.edit'))
            <!-- Category form start -->
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Sub-Category Update</h2>
                </div>
                <!-- Category form start -->
                <form action="{{ route('sub-category.update', $subCategory->id) }}" method="POST">
                    ...
                    <div class="flex flex-col gap-4 p-4 mt-3">
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <div class="w-full">
                                <h4 class="mb-2 font-medium text-zinc-700">Select Category</h4>
                                <div class="relative inline-flex w-full">
                                    ...
                                    <select name="category_id" class="w-full h-12 pl-4 pr-10 cursor-pointer bg-white border border-gray-300 rounded-md appearance-none text-zinc-700 focus:outline-none">
                            ...
                            <div class="w-full">
                                <div class="w-full">
                                    <h4 class="mb-2 font-medium text-zinc-700">Sub-Category Title</h4>
                                    <input placeholder="Enter Sub-Category Title" name="name" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" value="{{ $subCategory->name }}">
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col md:flex-row justify-between gap-3">
            ...
            @else
                <!-- Category form start -->
                    <div class="border border-[#8e0789] rounded-md mt-10">
                        <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                            <h2 class="text-2xl font-bold py-2 text-white pl-3">Sub-Category Create</h2>
                        </div>
                        <!-- Category form start -->
                            ...
                            <div class="flex flex-col gap-4 p-4 mt-3">
                                <div class="flex flex-col md:flex-row justify-between gap-3">
                                    ...
                                    <div class="w-full">
                                        <div class="w-full">
                                            <h4 class="mb-2 font-medium text-zinc-700">Sub-Category Title</h4>
                                            <input placeholder="Enter Sub-Category Title" name="name" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                        </div>
                                    </div>
                    ...
                    <div class="border border-[#8e0789] rounded-md mt-10">
                        <div class="bg-[#8e0789] overflow-hidden w-full px-0 flex items-center">
                            <h2 class="text-2xl font-bold py-2 text-white pl-3">Sub-Category List</h2>
                        </div>
                            ...
                            <table class="text-sm text-left text-white border-l border-r" id="dataTableAuthor" style=" width: 100%;">
                                ...
                                <tr class=" bg-white   dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="whitespace-nowrap space-x-1 text-center px-2 flex items-center justify-center">
                                        <a href="{{ route('sub-category.edit', $item->slug) }}" class="text-white bg-sky-400 hover:bg-sky-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-5 py-2 text-center">
                                            <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                                            Edit
                                        </a>
                                        <a href="{{ route('sub-category.destroy', $item->id) }}" type="button" class="text-white bg-red-500 hover:bg-red-600 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-3 py-2 text-center deleteConfirmAuthor">
