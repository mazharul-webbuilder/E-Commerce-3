    ...
    <section class="w-1/2 bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                ...
                <!-- Settings form start -->
                <form action="{{ route('settings.2p.update') }}" method="POST">
                    @csrf
                    <div class="flex flex-col gap-4 p-4 mt-3">
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <div class="w-full">
                                <div class="w-full">
                                    <h4 class="mb-2 font-medium text-zinc-700">Player Entry Coin Multiply By (For winniner)
                                    </h4>
                                    <input name="winner_coin_multiply_value"
                                        value="{{ $free_two_player_settings->winner_coin_multiply_value ?? 0 }}"
                                        min="1"
                        ...
                        <div class="w-full flex justify-end">
                            <button type="submit"
                                class="inline-block px-8 py-2.5 font-medium text-center transition-all ease-in-out text-white rounded-md bg-[#3f3ff3] cursor-pointer hover:bg-blue-800">
                                Submit
                            </button>
                        </div>
                    </div>
