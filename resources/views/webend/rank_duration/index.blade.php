        ...
        <div class="container px-2 mx-auto xl:px-5"  >
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0 flex items-center">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Rank duration update</h2>
                </div>
                <div class="py-2 px-1 mt-3" style="overflow-x: auto;" >
                    <table class="text-sm text-left text-white border-l border-r" id="dataTableAuthor" style=" width: 100%;">
                        ...
                        <tbody >
                        @foreach($rank_durations as $rank_duration)
                            @if($rank_duration->constant_title != 'member_to_vip')
                            <tr class=" bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-2 py-4 text-black border-r text-center">
                                    <a href="javascript:void(0)" data-action="{{route('show_product_status')}}" duration_title="{{$rank_duration->title}}" duration="{{$rank_duration->duration}}" rank_duration_id="{{$rank_duration->id}}"
                                       class="show_rank_duration text-white bg-purple-400 hover:bg-sky-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center
                                         px-5 py-2 text-center"
                                        data-te-toggle="modal"
                                        data-te-target="#exampleModal"
                                        data-te-ripple-init
                                        data-te-ripple-color="light">
                                        <i class="fas fa-solid fa-tag px-2"></i> Edit
                                    </a>
                                </td>
...
@section('extra_js')
    <script !src="">
        $(function (){
            ...
            $("body").on('click','.show_rank_duration',function (){

                $('.set_duration_title').val($(this).attr('duration_title'))
                $('.set_duration').val($(this).attr('duration'))
                $('.set_duration_id').val($(this).attr('rank_duration_id'))
            })
