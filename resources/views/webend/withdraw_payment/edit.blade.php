        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Withdraw Payment Update</h2>
                </div>
                <!-- Category form start -->
                <form id="submit_form" data-action="{{ route('withdraw_payment.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-full">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Payment Name" name="name" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" value="{{$payment->name}}">
                            ...
                            <div class="w-full">
                                <div class="w-full">
                                    ...
                                    <img src="{{ asset('uploads/withdraw_payment/resize/'.$payment->image) }}" alt="payment Image" class="h-12 w-12 pt-2">
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <div class="w-full">
                                <div class="w-full">
                                    ...
                                    <input placeholder="Enter Priority" name="priority"  id="priority" class=" w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" value="{{$payment->priority}}">
