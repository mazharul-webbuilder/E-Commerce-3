    ...
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                ...
                <!-- Category form start -->
                <form id="submit_form" data-action="{{route('shareholder.store_share_owner')}}" method="POST">
                    @csrf
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                                ...
                                <div class="w-full">
                                    <div class="w-full">
                                        ...
                                        <input placeholder="Name" name="name" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" >
                                ...
                                <div class="w-full">
                                    <div class="w-full">
                                        ...
                                        <input placeholder="Balance" name="balance" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="number" stap="any">
