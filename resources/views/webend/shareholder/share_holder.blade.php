                            ...
                            @foreach ($share_holders as $data)
                                <tr
                                    ...
                                    <td class="px-2 py-4 text-black border-r text-center">
                                        {{ price_format($data->total_purchase_cost, 2) }}
                                    </td>
                                    <td class="px-2 py-4 text-black border-r text-center">
                                        {{ $data->total_share }}
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap space-x-1 text-center px-2 flex items-center justify-center">
                                        ...
                                        <a href="{{route('shareholder.user_all_share',$data->user_id)}}"
                                           class="  text-white bg-red-500 hover:bg-sky-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-5 py-2 text-center ">
                                            View Detail
                                        </a>

                                        <a share_holder_id="{{ $data->user_id }}" data-bs-toggle="modal"
                                            data-te-toggle="modal" data-te-target="#exampleModal" data-te-ripple-init
                                            data-te-ripple-color="light" href="javascript:void(0)"
                                            class="show_modal_data hidden text-white bg-red-500 hover:bg-sky-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-5 py-2 text-center ">
                                            Detail View
                                        </a>
                                    </td>
                                </tr>
