        ...
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Club Info</span>
                        </div>
                    </li>
                </ol>
            </div>
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Profile Information</h2>
                </div>
                <!-- Category form start -->
                <form id="submit_form" data-action="{{ route('club_owner.update_profile') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex flex-col gap-4 p-4 mt-3">
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full">
                                    ...
                                    <input name="name" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none"
                                           type="text" required value="{{$auth_user->name}}">
                            ...
                            <div class="w-full">
                                ...
                                <input name="phone" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="text" value="{{$auth_user->phone}}">
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full">
                                    ...
                                    <input name="email" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none"
                                           type="text" value="{{$auth_user->email}}" readonly>
                            ...
                            <div class="w-full">
                                ...
                                <input name="password" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="password">
                                <span class="password error text-red-400"></span>
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-full">
                                ...
                                <img class="w-24" src="{{asset('uploads/club_owner/'.$auth_user->avatar)}}" alt="logo">
                    ...
                    error:function(response){
                        if (response.status === 422) {
                            if (response.status === 422) {
                                ...
                                if (response.responseJSON.errors.hasOwnProperty('avatar')) {
                                    $('.avatar_error').html(response.responseJSON.errors.avatar)
                                }else{
                                    $('.avatar_error').html('')
                                }
                            }
