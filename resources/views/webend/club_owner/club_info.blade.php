        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Club Information Update</h2>
                </div>
                <!-- Category form start -->
                <form id="submit_form" data-action="{{ route('club_owner.update_club_info') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full">
                                    ...
                                    <input name="club_name" class="w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none"
                                           type="text" required value="{{$club->club_name}}">
                            ...
                            <div class="w-full">
                                ...
                                <input name="logo" class="dropify w-full h-12 px-4 border border-gray-300 rounded-md text-zinc-700 focus:outline-none" type="file">
                                <span class="logo_error text-red-400"></span>
                                <img class="w-24" src="{{asset('uploads/club_logo/'.$club->logo)}}" alt="logo">
