    ...
    <section class="w-full bg-white p-3 mt-5">
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <section>
                <div class="flex items-center gap-4 pt-4">
                    <div class="flex-none inline-block">
                        <a href="{{ route('club_owner.tournament_index') }}" class="flex items-center cursor-pointer justify-center w-9 h-9 bg-white border border-gray-300 rounded-full hover:text-white hover:bg-blue-800 hover:scale-105">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                ...
                <form action="{{ route('club_owner.update_game_round') }}" method="post">
                    @csrf
