            ...
            <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                ...
                <li aria-current="page" class="flex items-center">
                    ...
                    <div class="flex items-center">
                        <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Board</span>
                    </div>
                </li>
            </ol>
        </div>
        ...
        <section>
            <div class="flex items-center gap-4 pt-4">
                <div class="flex-none inline-block">
                    <a href="{{route('all.round',$round->game->id)}}" class="flex items-center cursor-pointer justify-center w-9 h-9 bg-white border border-gray-300 rounded-full hover:text-white hover:bg-blue-800 hover:scale-105">
            ...
            <div class="py-2 px-1 mt-3" style="overflow-x: auto;">
                <table class="text-sm text-left text-white border-l border-r" id="dataTableAuthor" style=" width: 100%;">
                    ...
                    <tr class=" bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-2 py-4 text-black border-r text-center">
                            {{ $board->tournament->tournament_name }}
                        </td>
                        <td class="px-2 py-4 text-black border-r text-center">
                            {{ $board->game->game_no }}
                        </td>
                        <td class="px-2 py-4 text-black border-r text-center">
                            {{ $board->round->round_no }}
                        </td>
                        <td class="px-2 py-4 text-black border-r text-center">
                           @if($board->status == 0)
                               Pending
                        ...
                        <td class="whitespace-nowrap space-x-1 text-center px-2 flex items-center justify-center">
                            ...
                            <a href="{{ route('bidding_list.board',$board->id) }}" class="text-white py-2 bg-emerald-400 hover:bg-emerald-500 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-5 text-center">
                                Biding List
                            </a>
                            <a href="{{ route('playerlist.board',$board->id) }}" class="text-white bg-fuchsia-500 hover:bg-fuchsia-600 transition-all ease-in-out font-medium rounded-md text-sm inline-flex items-center px-5 py-2 text-center">
                                Player List
                            </a>
