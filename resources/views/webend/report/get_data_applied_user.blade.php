        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10 mb-6">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Data Applied Users List</h2>
                </div>
                    ...
                    <table class="text-sm text-left text-white border-l border-r" id="dataTableAuthor" style=" width: 100%;">
                        ...
                        @foreach($datas as $data)
                            <tr class="bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-2 py-4 text-black border-r text-center">
                                    {{ $data->data_applied_date }}
                                </td>
                                <td class="px-2 py-4 text-black border-r text-center">
                                    {{ $data->data_apply_expired_date }}
                                </td>
                                <td class="px-2 py-4 text-black border-r text-center">
                                    {{ count($data->get_data_applied_user()) }}
                                </td>

                                <td class="px-2 py-4 text-black border-r text-center">
                                    <a href="{{route('user.data_applied_list',$data->id)}}">View Users</a>
                                </td>
