        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10 mb-6">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Token transfer history</h2>
                </div>
                <br>

                <div class="px-2 py-4">
                    <span>
                        <a href="{{ route('get_token_transfer_history', ['type' => 'green']) }}"
                ...
                <form id="search_order_by_date" action="{{ route('get_token_transfer_history_date', ['type' => 'green']) }}"
