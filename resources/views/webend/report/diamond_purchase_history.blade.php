        ...
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Diamond Purchase
                                History</span>
                        </div>
                    </li>
                </ol>
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0 flex items-center">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Diamond Sell History</h2>
                </div>
                <br>

                <div class="px-2 py-4">
                    <span>
                        <a href="{{ route('diamond_purchase_history') }}"
                ...
                <form id="search_order_by_date" action="{{ route('diamond_purchase_history_by_date') }}" method="POST"
                    style="display: none">
                    @csrf
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr
                                    ...
                                    <td class="px-2 py-4 text-black border-r text-center">
                                        {{ $data->type == 1 ? 'Normal sell' : 'Package Sell' }}
                                    </td>
                                    <td class="px-2 py-4 text-black border-r text-center">
