        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10 mb-6">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">All Diamond Holders List</h2>
                </div>

                <div class="px-2 py-4">
                    <span>
                        <a href="{{ route('diamond_holder_user') }}"
                ...
                <form id="search_order_by_date" action="{{ route('diamond_holder_user_by_date') }}" method="POST"
                    style="display: none">
                    @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($users as $user)
                                <tr
                                    ...
                                    <td class="px-2 py-4 text-black border-r text-center">
                                        <span class="p-1">{{ $user->paid_diamond }}</span>
                                    </td>
