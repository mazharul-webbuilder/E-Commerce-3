        ...
        <div class="container px-2 mx-auto xl:px-5">
            ...
            <div class="border border-[#8e0789] rounded-md mt-10 mb-6">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">All ShareHolder's List</h2>
                </div>


                <div class="px-2 py-4">
                    <span>
                        <a href="{{ route('share_holder_list') }}"
                ...
                <form id="search_order_by_date" action="{{ route('share_holder_list_date') }}" method="POST"
                    style="display: none">
                    @csrf
