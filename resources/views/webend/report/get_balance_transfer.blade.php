        ...
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Balance Transfer
                                History</span>
                        </div>
                    </li>
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0 flex items-center">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Wining coin to gift</h2>
                </div>
                <br>
                <div class="px-2 py-4">
                    <span>
                ...
                <form id="search_order_by_date"
                    action="{{ route('get_transfer_balance_date', ['constant_title' => 'win_to_gift']) }}" method="POST"
                    style="display: none">
                    @csrf
                        ...
                        <tbody>
                            @foreach ($histories as $data)
                                <tr
                                    ...
                                    <td
                                        class="px-2 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap border-r text-center">
                                        {{ player_name($data->user_id) }} ({{ player_id($data->user_id) }})
                                    </td>
                                    <td
                                        class="px-2 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap border-r text-center">
                                        {{ str_replace('_', ' ', $data->depart_from) }}
                                    </td>

                                    <td class="px-2 py-4 text-black border-r text-center">
                                        {{ str_replace('_', ' ', $data->destination_to) }}
                                    </td>
                                    <td class="px-2 py-4 text-black border-r text-center">
