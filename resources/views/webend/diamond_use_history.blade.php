        ...
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Diamond use
                                History</span>
                        </div>
                    </li>
                </ol>
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0 flex items-center">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Diamond Use History</h2>
                </div>

                <div class="px-2 py-4">
                    <span><a href="{{ route('diamond_used_history') }}"
                ...
                <form id="search_order_by_date" action="{{ route('diamond.search_by_date') }}" method="POST"
                    style="display: none">
                    @csrf
                ...
                <div class="py-2 px-1 mt-3" style="overflow-x: auto;">
                    ...
                    <table class="text-sm text-left text-white border-l border-r" id="dataTableAuthor"
                        ...
                        <tbody>
                            @foreach ($diamond_histories as $data)
                                <tr
