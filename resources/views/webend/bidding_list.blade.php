        ...
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Biding</span>
                        </div>
                    </li>
                </ol>
            </div>
            ...
            <div class="border border-[#8e0789] rounded-md mt-10">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0 flex items-center">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Biding List</h2>
                    <div class="text-center text-2xl font-bold text-white flex items-center justify-center w-10/12">
                        Board No: {{ ucfirst($board_data->board) }}
                    </div>
                </div>
...
{{--                            </th>--}}
                        ...
                        <tr class=" bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-2 py-4 text-black border-r text-center">
                              {{ player_name($data->userid) }} {{ player_id($data->userid) }}
                            </td>
                            <td class="px-2 py-4 text-black border-r text-center">
                            ...
                            <td class="px-2 py-4 text-black border-r text-center">
                                {{ player_name($data->bided_to) }} ( {{ player_id($data->bided_to) }})
                            </td>
                            <td class="px-2 py-4 text-black border-r text-center">
                              @if($data->status == 0)
                                  Pending
