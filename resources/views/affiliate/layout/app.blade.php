        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <div class="text-xl font-bold ml-1 md:ml-16 flex items-center">
                    <a href="{{ route('affiliate.dashboard') }}" class="cursor-pointer">
                    ...
                    <div class="dropdown relative">
                        ...
                        <div id="dropdownAvatarName" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                            <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                                <div class="font-medium ">{{$affiliator->name}}</div>
                                <div class="truncate">{{$affiliator->email}}</div>
                            </div>
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformdropdownAvatarNameButtonationButton">
                                <li>
                                    <a href="{{route('affiliate.dashboard')}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Dashboard</a>
                                </li>
                                <li>
                                    <a href="{{route('affiliate.profile')}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Profile</a>
                                </li>
                                @if(!isConnectedWithUserAccount(USER['affiliator']))
                                    <li>
                                        <a href="{{route('affiliate.connect.with.user.account')}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                            Connect With User Account
                                        </a>
                                    </li>
                                @else
                                    <li>
                                        <a href="{{route('affiliate.connected.user.account')}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            ...
                            <div class="py-2">
                                <a href="{{ route('affiliate.logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();"  class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</a>
            ...
            <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                <div class="flex-1 px-3 bg-[#1b1b9b] divide-y space-y-1">
                    <ul class="space-y-2 pb-6" id="sidenavExample">
                        <li>
                            <a href="{{ route('affiliate.dashboard') }}" class="text-lg text-white font-normal rounded-lg {{ Request::routeIs('affiliate.dashboard') ? 'bg-blue-500' : '' }} flex items-center p-2 hover:bg-blue-500 group active:bg-blue-500">
                        ...
                        <li>
                            <a href="{{route('affiliate.orders')}}" class="text-lg text-white font-normal rounded-lg  flex items-center p-2 hover:bg-blue-500 group active:bg-blue-500">
                                <i class="fas fa-trophy text-white group-hover:text-white transition duration-75"></i>
                                <span class="ml-3 group-hover:text-white transition duration-150">Orders</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('affiliate.withdraw.history')}}" class="text-lg text-white font-normal rounded-lg  flex items-center p-2 hover:bg-blue-500 group active:bg-blue-500">
                                <i class="fas fa-trophy text-white group-hover:text-white transition duration-75"></i>
