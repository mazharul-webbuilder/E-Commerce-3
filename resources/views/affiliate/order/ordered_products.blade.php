        ...
        <div class="container px-2 mx-auto xl:px-5">
                ...
                <ol class="flex items-center space-x-1 md:space-x-3 flex-wrap">
                    ...
                    <li aria-current="page" class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 dark:text-gray-400">Ordered Products</span>
                        </div>
                    </li>
                </ol>
            </div>
            ...
            <div class="border border-[#8e0789] rounded-md mt-5 mb-8">
                <div class="bg-[#8e0789] overflow-hidden w-full px-0 flex items-center">
                    <h2 class="text-2xl font-bold py-2 text-white pl-3">Order Number:  {{$order->order_number}}</h2>
                    ...
                    <table class="text-sm text-left text-white border-l border-r" id="dataTable" style=" width: 100%;">
                        ...
                        @foreach($order->seller_order_detail as $orderDetail)
                            <tr>
                                ...
                                <td><a href="{{route('affiliate.product.view', $orderDetail->product->id)}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Details</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
