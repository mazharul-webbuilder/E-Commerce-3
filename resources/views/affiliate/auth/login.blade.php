...
<div class="mx-auto md:h-screen flex flex-col justify-center items-center px-6 pt-8 pt:mt-0">
    <a href="" class="text-2xl font-semibold flex justify-center items-center mb-8 lg:mb-10">
        ...
        <span class="self-center text-sm font-bold whitespace-nowrap uppercase">{{ config('app.name')}} Affiliate Login</span>
    </a>
    ...
    <div class="bg-white shadow rounded-lg md:mt-0 w-full sm:max-w-screen-sm xl:p-0">
        <div class="p-6 sm:p-8 lg:p-16 space-y-8">
            ...
            <form id="submit_form" class="mt-8 space-y-6" data-action="{{ route('affiliate.show_form_submit') }}" method="post">
                @csrf
                <div>
                    ...
                    <div class="w-full">
                        <div class="text-sm w-full ">
                            <p style="text-align: right">
                                <a href="{{route('forget.password', FORGET_PASSWORD_BY['affiliator'])}}" class="text-blue-600">Forget Password ?</a>
                            </p>
                        </div>
                    </div>
